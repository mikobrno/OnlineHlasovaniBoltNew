-- KOMPLETNÍ DATABÁZE - VŠECHNY TABULKY
-- Vytvořím všechne potřebné tabulky pro plnou funkcionalitu

-- Smazat všechny existující tabulky
...
-- Vytvořit všechny tabulky v správném pořadí
...
SELECT 'SUCCESS: Kompletní databáze je připravena!' as status;
...
UNION ALL
SELECT 'email_templates' as table_name, COUNT(*) as rows FROM email_templates
UNION ALL
SELECT 'manual_vote_attachments' as table_name, COUNT(*) as rows FROM manual_vote_attachments
UNION ALL
SELECT 'manual_vote_notes' as table_name, COUNT(*) as rows FROM manual_vote_notes;
